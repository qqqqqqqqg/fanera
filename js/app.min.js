...
window.addEventListener('DOMContentLoaded', () => {
	...
	function documentActions(e) {
		...
		if (target && target.classList.contains('search-form__icon')) {
			document.querySelector('.search-form').classList.toggle('_active');
		} else if (target && !target.closest('.search-form') && document.querySelector('.search-form._active')) {
	...
	function loadProducts(data) {
		...
		data.products.forEach(item => {
			...
			const productLikeUrl = item.priceOld;
			...
			let productTemplateActions = `
				<div class="item-product__actions actions-product">
					<div class="actions-product__body">
						<a href="" class="actions-product__button btn-slider btn-slider_white">Add to cart</a>
